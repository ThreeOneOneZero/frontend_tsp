    ...
    graph: {
      ...
      info: {
        ...
        data: {
          ...
          impossibleRoutesDesc: "Conexões que não existem no grafo são representadas com distância muito alta (999999). O algoritmo genético naturalmente eliminará essas rotas da população ao longo das gerações.",
        },
      },
    },
    errors: {
