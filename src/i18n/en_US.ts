    ...
    graph: {
      ...
      info: {
        ...
        data: {
          ...
          impossibleRoutesDesc: "Connections that don't exist in the graph are represented with very high distance (999999). The genetic algorithm will naturally eliminate these routes from the population over generations.",
        },
      },
    },
    errors: {
